...
plot(P_Ratios~B_Ratios+SE_Ratios)
...
Model<-lm(P_Ratios~B_Ratios+SE_Ratios)
...
P_2000RatioChangePrediction<-Model$coefficients[1]+B_Ratios*Model$coefficients[2]+SE_Ratios*Model$coefficients[3]
...
hist((P_2000Prediction-P_2000),20,xlim=c(-100000,100000),col="yellow")
...
write.table(P_2000PredictionAndActual,file="C:/Users/Eddie/Desktop/YoungModelFit.csv",sep=",")
Sys.sleep(3)
