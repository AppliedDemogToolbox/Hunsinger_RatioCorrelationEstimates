...
M_Ratios<-(M_2000/sum(M_2000))/(M_1990/sum(M_1990))
...
P_2000RatioChangePrediction<-Model$coefficients[1]+M_Ratios*Model$coefficients[2]
...
write.table(P_2000PredictionAndActual,file="C:/Users/Eddie/Desktop/RetiredModelFit.csv",sep=",")
Sys.sleep(3)
